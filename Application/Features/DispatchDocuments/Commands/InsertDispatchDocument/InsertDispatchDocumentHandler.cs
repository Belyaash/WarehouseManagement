...
file sealed class InsertDispatchDocumentHandler : IRequestHandler<InsertDispatchDocumentCommand, InsertDispatchDocumentResponseDto>
{
    ...
    private DispatchDocument CreateDocument(InsertDispatchDocumentCommand request, DomainClient client)
    {
        ...
        var newDocument = new DispatchDocument(createParameters);
    ...
    private void CreateDocumentResources(InsertDispatchDocumentCommand request, DispatchDocument newDocument)
    {
